...
_reactDom2.default.render(_react2.default.createElement(_Hello2.default, null), document.getElementById('app')); // document.getElementById('app').innerHTML = "webpack works";
